...
<body>
	...
	<div id="container">
        ...
        <div class="actionBlock">
          ...
          <form action="StudentControllerServlet" method="GET">
            Sort by : <select name="sortOption" class="drowDown">
						<option selected="selected" value="A">First name</option>
						<option value="B">Last name</option>
						<option value="C">Study period</option>
						<option value="D">Study Year</option>
						<option value="E">Email</option>
						<option value="F">Scholar</option>
						</select>
						<input type="submit" value="Sort" class="add-student-button" />
						</form>
		</div>
